...
<body id="page-top">
  ...
  <header class="masthead d-flex">
    <div class="container text-center my-auto">
      ...
      <h3 class="mb-5">
        <em>Aplikasi Minat Dan Bakat</em>
      </h3>
      <a class="btn btn-primary btn-xl js-scroll-trigger" href="daftar.php">Register</a>
      <br>
      <p style="color: white;">Silakan <u><strong><a href="login.php" style="color:darkkhaki;"> Login
            </a></strong></u>
