...
<body>
	...
	<div class="container">
		...
		<div class="jumbotron">
			<center>
				<h2>Selamat datang di Sistem Pakar Deteksi Penyakit Kacang Hijau</h2>
				<p align="justify"><img src="" style="float:left; margin:2px 10px 3px 0px; border-radius:3px 0px 0px 3px;">Sebenernya ini tugas usmen... Ngasehekeun....!!!<br />
					<!-- Kalem <p align="justify"><strong>Gizi kurang:</strong> tidak cukup mendapatkan nutrisi. Ini berarti seseorang tidak mencukupi asupan protein, kalori, vitamin, atau mineral yang dibutuhkannya. Efek dari kekurangan asupan ini adalah gizi kurus atau wasting, stunting, dan berat badan kurang.</p>
	...
	<nav class="navbar navbar-default" style="bottom: 0;margin: 0">
		<div class="container">
			<center>
				...
				<!-- Kalem <ul class="nav navbar-nav navbar-right">
